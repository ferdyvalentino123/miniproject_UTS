        ...
        <div class="row justify-content-center">
            <div class="p-5 bg-light rounded-3 border col-xl-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="hargaBarang" class="form-label">Harga
                            Barang</label>
                        <input class="form-control @error('hargaBarang') isinvalid @enderror" type="text" name="hargaBarang"
                            id="hargaBarang" value="{{$barang->hargabarang }}" placeholder="Enter Harga Barang">
                        @error('hargaBarang')
                            <div class="textdanger"><small>{{ $message }}</small></div>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="deskripsiBarang" class="form-label">Deskripsi Barang</label><input
                            ...
                            id="deskripsiBarang" value="{{ $barang->deskripsibarang }}"placeholder="Enter Deskripsi Barang">
                ...
                <div class="row">
                    <div class="col-md-6 d-grid">
                        <a href="{{ route('barangs.index') }}" class="btn btn-outline-dark btn-lg mt-3"><i class="bi-arrow-left-circle me-2"></i>
                            Cancel</a>
                    </div>
                    <div class="col-md-6 d-grid">
